			...
			<div class="p-b-50">
				...
				<div class="p-r-20 p-r-0-sm t-center">
					<div class="cat-button" style="display: inline-block;">
						<a href="<?=site_url("shop/")?>" class="btn btn-outline-primary bo-rad-23 p-l-16 p-r-16 m-r-4 m-b-12 button-kategori">Semua Kategori</a>
						<?php 
							...
							foreach($db->result() as $r){
								$select = ($r->id == $idcat) ? "btn-primary" : "btn-outline-primary";
						?>
							<a href="<?=site_url("kategori/".$r->url)?>" class="btn bo-rad-23 p-l-16 p-r-16 m-r-4 m-b-12 button-kategori <?=$select?>">
