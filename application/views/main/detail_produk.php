      ...
      ?>
	      ...
	      <div class="modal-header">
			      	...
			      	<h5 class="modal-title fs-14"><?= $data->nama;?></h5>
					<?php 
								...
								<div class="flex-w p-b-10">
									...
									<div class="col-6 row p-lr-0 m-lr-0 m-t-10">
										<div class="wrap-num-product input-group col-12 p-lr-0">
											...
											<input class="form-control text-center num-product jumlahorder" type="number" min="<?php echo $data->minorder; ?>" name="jumlah" value="<?php echo $data->minorder; ?>"  required style="border:0px; height:29px; width: 50px; margin-left: 10px; margin-right: 10px; border-bottom: 1px solid #ccc">
