			...
			<div class="section pesanan-item p-lr-10 p-tb-10 m-lr-0-xl">
				...
				<div class="row m-lr-0">
					...
					<div class="row m-lr-0 p-lr-12 col-md-4">
						...
						<div class="color1 f-sm-12 f-md-16 p-lr-0 col-6 col-md-12 font-bold"><strong>IDR <?php echo $this->func->formUang($res->saldo + $res->transfer); ?></strong></div>
					</div>
				</div>
				<hr>
				<div class="row">
					...
					<div class="col-md-6">
						<div class="row">
								...
								<?php
									...
									if($knf->num_rows() > 0){
										...
										foreach($knf->result() as $ref){
											echo "<br/><strong>waktu konfirmasi:</strong> <span>".$this->func->ubahTgl("d M Y H:i",$ref->tgl)." WIB</span>";
										}
										echo "</div>";
									}else{
										if($res->midtrans_id != ""){
								...
								?>
								<div class="col-6">
									<a href="javascript:void(0)" onclick="<?=$klik?>" class="btn btn-outline-colorbutton btn-block m-b-10 f-sm-12 f-md-14">
										Bayar Pesanan
									</a>
								</div>
								<div class="col-6">
									<a href="javascript:void(0)" onclick="konfirmasi(<?php echo $res->id; ?>)" class="btn btn-colorbutton btn-block m-b-10 f-sm-12 f-md-14">
										Konfirmasi
									</a>
								</div>
								<?php
