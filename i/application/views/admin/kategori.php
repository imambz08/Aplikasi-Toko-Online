<div style="">
	<a class="float-right btn btn-primary" href="<?=site_url("signin/kategoriform")?>"><i class="fas fa-plus-circle"></i> Tambah Kategori</a>
	...
	<div class="card">
		...
		?>
			<tr>
				...
				<td>
					<a href="<?php echo site_url("signin/kategoriform/".$r->id); ?>" class="btn btn-primary"><i class="fas fa-pencil-alt"></i> Edit</a>
...
<script type="text/javascript">
	...
	function hapusPromo(pro){
		swal.fire({
			...
			if(result.value){
				$.post("<?php echo site_url('signin/hapuskategori'); ?>",{"pro":pro,[$("#names").val()]:$("#tokens").val()},function(msg){
					var data = eval("("+msg+")");
	...
	function refreshTabel(page){
		window.location.href = "<?php echo site_url('signin/kategori/?page='); ?>"+page;
	}
</script>